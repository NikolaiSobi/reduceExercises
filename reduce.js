...
function extractValue(arr, key) {
    return arr.reduce((accumulator, arrLoop) => {
        accumulator.push(arrLoop[key]);
        return accumulator;
    }, []);
}
...
the value should be placed in the first subarray. If the result of the callback function 
